...
const Points = () => {
  ...
  useEffect(() => {
    async function loadPosition() {
      const { status } = await Location.requestPermissionsAsync(); //se deu permissão
    ...
    loadPosition(); // para poder utilizar o async await
  ...
  function handleNavigateToDetail(id: number) {
    navigation.navigate('Details', {point_id: id}); //tudo que estiver dentro do objeto vai ser passado como paramêtro
  }
  ...
  function handleSelectItem(id: number) {
    ...
    if (alreadySelected >= 0) {
      ...
      //contêm todos os items menos o que quer remover
    }
    else {
